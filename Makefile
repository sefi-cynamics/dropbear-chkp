...
CLISVROBJS=common-session.o packet.o common-algo.o common-kex.o \
			...
			common-runopts.o circbuffer.o curve25519-donna.o list.o netio.o udp-listener.o
...
ifeq (0, 1)
	allobjs = $(COMMONOBJS) fuzz-common.o  fuzz-wrapfd.o $(CLISVROBJS) $(CLIOBJS) $(SVROBJS) -lcrypt
...
INSTALL=install
CPPFLAGS=
CFLAGS+=-I. -I$(srcdir) $(CPPFLAGS) -Os -W -Wall -Wno-pointer-sign -fno-strict-overflow -fPIE -fstack-protector-strong -D_FORTIFY_SOURCE=2
LIBS+=-lutil -lz 
LDFLAGS= -Wl,-pie -Wl,-z,now -Wl,-z,relro
...
fuzzer-preauth: fuzzer-preauth.o $(HEADERS) $(LIBTOM_DEPS) Makefile $(svrfuzzobjs)
	$(CXX) $(CXXFLAGS) $@.o $(LDFLAGS) $(svrfuzzobjs) -o $@$(EXEEXT) $(LIBTOM_LIBS) $(LIBS) $(FUZZLIB) -lcrypt
